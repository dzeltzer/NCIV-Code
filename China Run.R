...
replicate_table_3 <- function(workfile_china, col_2_controls, col_3_controls,
...
run_china_nciv <- function(data, instrument_form, instrument,
                           col_2_controls, col_3_controls,
                           col_4_controls, col_5_controls, col_6_controls,
                           weights, variables_to_remove, permutations,
                           OOB, mtry_ratio, ntree, title)
  {
